...
// Mongoose est une singleton : permet de créer une instance qui est stockée dans une variable statique et il ne faut pas la répéter, il renvoie l'existant
...
require(`${process.cwd()}/models/Product`)
